...
void didChangeDependencies() {
  ...
  controller: requestController.numberOfPeopleController,
  warning: requestController.numberOfPeopleWarning,
  label: 'Number of People',
);
if (number == null) return;

final hours = requestController.validateIntField(
  controller: requestController.hoursNeededController,
  warning: requestController.hoursNeededWarning,
  label: 'Hours Needed',
);
if (hours == null) return;
    ...
    final updatedStatus = requestController.determineRequestStatus(
      widget.request.copyWith(numberOfPeople: number),
                      ...
                      children: [
                        CustomFormField(
                          ...
                          onChanged: (value) => requestController.validateIntegerInput(
                            value: value,
                            warningText: requestController.hoursNeededWarning,
                            ...
                            CustomFormField(
                              ...
                              keyboardType: TextInputType.number,                            
                               inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'\d'))],
                                ...
                                onChanged: (value) => requestController.validateIntegerInput(
                                  value: value,
                                  warningText: requestController.numberOfPeopleWarning,
